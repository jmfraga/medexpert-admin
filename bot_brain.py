...
def _search_perplexity(query_text: str, settings: dict) -> list[dict]:
    ...
    try:
        ...
        prompt = (
            "Busca informacion cientifica y clinica relevante sobre este caso.\n\n"
            "PREFERENCIAS (no estrictas):\n"
            "- Preferir articulos de revistas medicas cuando esten disponibles\n"
            "- Preferir publicaciones de los ultimos 15 años\n"
            "- Preferir: meta-analisis, revisiones sistematicas, ensayos clinicos, guias clinicas\n"
            "- Journals de alto impacto son preferidos pero no obligatorios\n"
            "- Si no hay articulos peer-reviewed, incluir guias clinicas, consensos o informacion "
            "de sociedades medicas (NCCN, ESMO, ASCO, etc.)\n\n"
            f"Caso clinico: {query_short}\n\n"
            "Responde con los 5 resultados mas relevantes. "
